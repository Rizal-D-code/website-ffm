...
<div class="jumbotron banner_area jumbotron-fluid" style="margin-top: 60px; background-image: url(<?= base_url('img/banner_area/sekolah.jpg') ?>); ">
	<div class="container">
		<h1 class="display-4 my-auto text-light text-center" style="text-shadow: 2px 2px 2px black;">Berita</h1>
	</div>
</div>
			...
			<?php foreach($news as $n) : ?>
				<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 my-3">
					<div class="card" style="width: 15rem; height: 24rem;">
						...
						<div class="card-body">
							<h5 class="card-title"><?= character_limiter($n->title,40) ?></h5>
							<p class="card-text"><?= character_limiter($n->content,55) ?></p>
							<a href="<?= base_url("index.php/blog/baca/$n->seo_title") ?>" class="btn btn-info btn-sm">Lanjut Membaca<i class="fa fa-angle-right ml-2"></i></a>
						</div>
					</div>
				</div>
			<?php endforeach ?>
