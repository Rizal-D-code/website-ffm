	...
	public function ajax_list()
   {
	...
	public function add()
	{
		...
		if($this->form_validation->run() == false){
			...
			$this->session->set_flashdata('success', 'Kerjasama Berhasil Ditambahkan.');
	...
	public function edit($id)
	{
		...
		$this->form_validation->set_rules('name', 'Nama','required',[
			'required' => 'Nama Kerjasama tidak boleh kosong!'
			]
		);
		...
		if($this->form_validation->run() == false){
			...
			$this->session->set_flashdata('success', 'Kerjasama Berhasil Diupdate.');
